...
class jansrediskernel(Kernel):
    ...
    def do_complete(self, code, cursor_pos):
        ...
        for command in commands:
            if command.startswith(code.upper()):
